...
def restaurant_desc(city,rest):
    ...
    output += ' ' + '\n'
    output += 'Stars: ' + '\n'
    output +=  str(yelp_rest.sort_values(by=['stars','useful'],ascending=False)['stars'].iloc[0]) + '\n'
    output += ' ' + '\n'
    output += 'Review: ' + '\n'
    output += ' ' + '\n'
    ...
    output += ' ' + '\n'
    output += 'Stars: ' + '\n'
    output +=  str(yelp_rest.sort_values(by=['stars','useful'],ascending=[True,False])['stars'].iloc[0]) + '\n'
    output += ' ' + '\n'
    output += 'Review: ' + '\n'
    output += ' ' + '\n'
    output +=  yelp_rest.sort_values(by=['stars','useful'],ascending=[True,False])['text'].iloc[0] + '\n'
    return output
